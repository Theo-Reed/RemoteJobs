export const membership = {
    quotaExceededTitle: { Chinese: '额度点数不足', English: 'Quota Exceeded' },
    quotaExceededContent: { Chinese: '您的简历生成额度已用完，请在“我” -> “会员中心”获取更多点数。', English: 'Your resume quota has been exhausted. Please get more points in "Me" -> "Member Center".' },
